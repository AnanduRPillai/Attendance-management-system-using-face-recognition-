...
SECRET_KEY = "django-insecure-3q6s(8^r7td73qu$69b($+pz9h_$)bz=p=w1x!ax1jfa$a%0i+"  # Consider using your secret key
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'main_app/faces')
